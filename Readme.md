...
| Directory (`exp*`)                               | Domain                  | Specific Task                        | Params          |            
| ------------------------------------------------ | ----------------------- | ------------------------------------ | --------------- | 
| `exp1_medium_range_weather_forecasting`          | Atmospheric Science     | Medium-range Weather                 | 1B              | 
| `exp2_long_term_stability_test`                  | Atmospheric Science     | Long-term Stability Test             | 0.02B           | 
| `exp3_multi_year_climate_simulation`             | Atmospheric Science     | Multi-year Climate Sim.              | 0.1B            | 
| `exp4_global_ocean_simulation_and_forecasting`   | Oceanography            | Global Ocean Simulation              | 0.02B           | 
| `exp6_high_fidelity_eddy_forecast`               | Oceanography            | High-Fidelity Eddy Forecast          | 0.028B          | 
| `exp6_high_fidelity_eddy_forecast`               | Oceanography            | Zero-shot Generalization             | 0.002B          | 
| `exp7_isotropic_turbulence`                      | Theoretical Physics     | 2D Isotropic Turbulence              | 0.02B           | 
