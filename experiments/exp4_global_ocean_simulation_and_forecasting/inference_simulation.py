...
def setup(params):
    ...
    model = build_model("Triton", experiment="global_ocean_simulation", params=params).to(device)
    ...
    climate_mean = np.load('./data/climate_mean_s_t_ssh.npy', mmap_mode='r')[:365, :, :, :]
    ...
    with torch.no_grad():
        for i in range(valid_data.shape[0]): 
            if i==0: # start of sequence, t0 --> t0'
                ...
                future_force = future[params.atmos_channels, :720, :1440]
