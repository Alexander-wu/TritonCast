...
BACKBONE = 'regional_agu_forcasting_025degree_daily_20250808'
BASE_LOG_DIR = '/jizhicfs/Prometheus/Triton4Earth_V2/Scenario_3_Ocean_stream/regional_agulhas_forcasting_0.125degree_daily'
...
config = {
    'data_dir': '/jizhicfs/Prometheus/Triton4Earth_V2/Scenario_3_Ocean_stream/dataset/Agulhas_dataset',
...
def main():
    ...
    h, w = 80, 160 # Downsampled image height and width, please confirm based on your data and downsampling factor
    model = Triton(
