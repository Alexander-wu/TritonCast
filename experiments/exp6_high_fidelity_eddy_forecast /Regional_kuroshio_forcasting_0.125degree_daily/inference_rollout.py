...
BACKBONE = 'regional_kuroshio_forcasting_025degree_daily_20250808'
BASE_LOG_DIR = '/jizhicfs/Prometheus/Triton4Earth_V2/Scenario_3_Ocean_stream/regional_kuroshio_forcasting_0.125degree_daily'
...
config = {
    'data_dir': '/jizhicfs/Prometheus/Triton4Earth_V2/Scenario_3_Ocean_stream/dataset/kuroshio_dataset',
